...
Key steps
  ...
  2. Download Release Temperature Data from Grand Canyon Monitoring and Research Center Website
      A. Glen Canyon Dam Release Water Temperature near Page AZ - gcmrcTemp.tsv (csv file). Grand Canyon Monitoring and Research Center https://www.gcmrc.gov/discharge_qw_sediment/station/GCDAMP/09379901#.
...
#cPackages <- c("tidyverse", "readxl", "RColorBrewer", "dplyr", "expss", "reshape2", "pracma", "lubridate", "directlabels", "plyr", "stringr", "ggplot2")
# 
# # Then we select only the packages that aren't currently installed.
#   install.lib <- cPackages[!cPackages %in% installed.packages()]
# # And finally we install the missing packages, including their dependency.
#   for(lib in cPackages) install.packages(lib,dependencies=TRUE)
#   # After the installation process completes, we load all packages.
#   dum <- sapply(load.lib,require,character=TRUE)


cPackages <- c("googlesheets4", "dygraphs", "tidyquant", "xts", "tidyverse", "tidyquant","lubridate", "stringr", "rvest", "RColorBrewer", "ggplot2", "dplyr", "expss", "reshape2", "pracma", "directlabels", "plyr")
...
if (any(installed_packages == FALSE)) {
  ...
  install.packages(cPackages[!installed_packages], dependencies = TRUE)
}
# Packages loading
