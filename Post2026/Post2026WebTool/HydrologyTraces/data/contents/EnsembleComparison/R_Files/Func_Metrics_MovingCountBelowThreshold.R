...
Func_MovingCountBelowThreshold <- function(data , Threshold=14.78 , Duration=10, ScenarioName="ISM_Full"){
  ...
  AveCountBT_hist <- Func_AveCountBT(data=HistData, Threshold , Duration)
  ...
  if(nTraces==1){
    ...
    legend("topleft", legend="Historical CBT ", 
           cex=0.9, 
           col="red", 
           lty=1,
           bty = "o",
