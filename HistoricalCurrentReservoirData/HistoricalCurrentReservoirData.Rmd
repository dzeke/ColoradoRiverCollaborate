...
ggplot() +
  ...
  geom_text(aes(x = as.Date("2021-01-01"), y = 21.7, label = cCurrent), fontface = "bold", color = "blue", size = 3) +    geom_text(aes(x = as.Date("2021-01-01"), y = 18.5, label = cPowellElevationsConcat), color = pReds[7], size = 3) +
