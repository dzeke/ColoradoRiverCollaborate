...
ggplot() +
  ...
  geom_text(aes(x = as.Date("2023-01-01"), y = 20.5, label = cCurrent), fontface = "bold", color = "blue", size = 3) +    geom_text(aes(x = as.Date("2023-01-01"), y = 17.5, label = cPowellElevationsConcat), color = pReds[7], size = 3) +
...
cCurrent <- paste0("Current active storage is:\n", nStorage, " maf (", nElevation," feet)")
...
ggplot() +
  ...
  geom_text(aes(x = as.Date("2022-01-01"), y = 19.5, label = cCurrent), fontface = "bold", color = "blue", size = 3) + 
  geom_text(aes(x = as.Date("2022-01-01"), y = 16, label = cMeadElevationsConcat), color = pReds[7], size = 3) +
